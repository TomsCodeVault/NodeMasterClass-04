 ...
 */
 ...
 cli.responders.help = function(){
   var commands = {
     ...
     'list users --{hours}' : 'Show a list of all users who have signed up in the last 24 hours. Parameter is optional for testing.',
     'more user info --{email}' : 'Show details of a specific user',
     'list menu items' : 'Show a list of all menu items',
     'list orders --{hours}' : 'Show a list of all orders placed in the last 24 hours (or the last --{hours})',
